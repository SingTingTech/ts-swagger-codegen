...
public class TypeScriptAxiosSimpleClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptAxiosSimpleClientCodegen() {
        super();
        importMapping.clear();
        outputFolder = "generated-code/typescript-axios-simple";
    ...
    public String getName() {
        return "typescript-axios-simple";
    }
    ...
    public Map<String, Object> postProcessOperations(Map<String, Object> operations) {
        ...
        List<CodegenOperation> codegenOperations = (List<CodegenOperation>) ((Map<String, Object>) operations.get("operations")).get("operation");
        for (CodegenOperation i : codegenOperations) {
            i.path = i.path.replaceAll("\\{", "\\$\\{");
